...
int main(int argc, char** argv)
{
  ...
  const double relative_offset = 10000.; // 7000. //600. //12000.
    ...
    // ------------------------------ALPHA WRAP INPUT---------------------------------------
    Mesh alpha_wrap = _3D_alpha_wrap(filename,relative_alpha,relative_offset, data, false, false, true, false, false); // set both to false if you do not want to write out the file and test if valid
